...
:root {
  /* 背景: 白ベースから温かいオフホワイトへ */
  --bg-primary:    #f7f5ef;   /* ページ背景（温かいオフホワイト） */
  --bg-secondary:  #efece4;   /* 交互セクションの背景（一段深い） */
  --bg-card:       #ffffff;   /* カード面は白でコントラストを確保 */

  /* 構造色: 個人サイトの濃いテキスト色に相当。見出し・ナビ・罫線の主役 */
  --ink:           #1a2740;   /* 見出し（display）最濃 */
  --text-primary:  #22314f;   /* 強めの本文・小見出し（深インディゴ） */
  --text-secondary:#4a4f57;   /* 説明文 */
  --text-muted:    #6b7078;   /* ラベル・補足 */

  /* アクセント: 一色のみ（コーラル）。CTAとホバー線にだけ使う */
  --accent:        #e5613c;
  --accent-dark:   #c24a28;   /* hover時 */
